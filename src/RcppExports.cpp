...
RcppExport SEXP rddsigma_em_gauss_gauss_helper(SEXP d_vecSEXP, SEXP w_vecSEXP, SEXP cutoffSEXP, SEXP init_sigmaSEXP, SEXP tolSEXP, SEXP maxitSEXP, SEXP integ_methodSEXP, SEXP integ_tolSEXP, SEXP integ_depthSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<int> >::type d_vec(d_vecSEXP);
...
RcppExport SEXP rddsigma_em_gauss_lap_helper(SEXP d_vecSEXP, SEXP w_vecSEXP, SEXP cutoffSEXP, SEXP init_sigmaSEXP, SEXP tolSEXP, SEXP maxitSEXP, SEXP integ_methodSEXP, SEXP integ_tolSEXP, SEXP integ_depthSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<int> >::type d_vec(d_vecSEXP);
